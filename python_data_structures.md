...
## 3. DICTIONARIES - Key-Value Pairs, Unordered (Python 3.7+ maintains insertion order)
...
- Allow duplicates
- Example: Shopping cart items, scores
...
- Example: (latitude, longitude), database records

DICTIONARIES:

- Need key-value relationships
- Fast lookups by unique identifier
- Example: Student records, configuration settings
...
- Fast membership testing
- Mathematical set operations
- Example: Unique visitors, tags, permissions
  """
